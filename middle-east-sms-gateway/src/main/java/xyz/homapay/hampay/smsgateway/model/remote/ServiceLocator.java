...
public class ServiceLocator extends org.apache.axis.client.Service implements xyz.homapay.hampay.smsgateway.model.remote.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://mehrafraz.com/webservice/service.asmx";
    ...
    public xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_BindingStub _stub = new xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://mehrafraz.com/webservice/service.asmx";
    ...
    public xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_PortType getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap12Stub _stub = new xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_BindingStub _stub = new xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_BindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap12Stub _stub = new xyz.homapay.hampay.smsgateway.model.remote.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
