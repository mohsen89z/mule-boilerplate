 ...
 */
public class IndividualPayConfirmExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<IndividualPaymentConfirmResponse> createResponseMessageObject() {
        ResponseMessage<IndividualPaymentConfirmResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new IndividualPaymentConfirmResponse());
