 ...
 */
public class ChangeMemWordExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<ChangeMemorableWordResponse> createResponseMessageObject() {
        ResponseMessage<ChangeMemorableWordResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new ChangeMemorableWordResponse());
