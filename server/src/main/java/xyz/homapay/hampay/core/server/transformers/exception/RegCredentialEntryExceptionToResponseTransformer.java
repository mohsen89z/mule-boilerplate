 ...
 */
public class RegCredentialEntryExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<RegistrationCredentialsResponse> createResponseMessageObject() {
        ResponseMessage<RegistrationCredentialsResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new RegistrationCredentialsResponse());
