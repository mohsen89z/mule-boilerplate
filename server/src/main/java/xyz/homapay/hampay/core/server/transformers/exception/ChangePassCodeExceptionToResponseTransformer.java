 ...
 */
public class ChangePassCodeExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<ChangePassCodeResponse> createResponseMessageObject() {
        ResponseMessage<ChangePassCodeResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new ChangePassCodeResponse());
