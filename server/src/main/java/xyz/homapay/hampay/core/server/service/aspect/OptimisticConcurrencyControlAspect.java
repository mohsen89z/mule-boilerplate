package xyz.homapay.hampay.core.server.service.aspect;
...
public class OptimisticConcurrencyControlAspect {
    ...
    @Around("@annotation(xyz.homapay.hampay.core.server.service.annotation.Retry)")
    public Object retry(ProceedingJoinPoint pjp) throws Throwable {
        Retry retryAnnotation = getRetryAnnotation(pjp);
        return (retryAnnotation != null) ? proceed(pjp, retryAnnotation) : pjp.proceed();
    }
