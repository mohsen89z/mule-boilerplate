 ...
 */
public class VerifyAccountExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<VerifyAccountResponse> createResponseMessageObject() {
        ResponseMessage<VerifyAccountResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new VerifyAccountResponse());
