 ...
 */
public class HpEnabledContactExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<ContactsHampayEnabledResponse> createResponseMessageObject() {
        ResponseMessage<ContactsHampayEnabledResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new ContactsHampayEnabledResponse());
