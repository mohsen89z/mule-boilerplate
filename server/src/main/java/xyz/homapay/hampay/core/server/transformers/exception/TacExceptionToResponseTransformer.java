 ...
 */
public class TacExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<TACResponse> createResponseMessageObject() {
        ResponseMessage<TACResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new TACResponse());
