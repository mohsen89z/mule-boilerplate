...
import xyz.homapay.hampay.common.switchbay.model.response.BankListResponse;
import xyz.homapay.hampay.core.server.helper.ExceptionUtility;

/**
 * Created by sima on 7/2/15.
 */
public class RegSMSTokenExceptionToResponseTransformer extends AbstractMessageTransformer {
