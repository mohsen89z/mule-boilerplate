 ...
 */
public class RegFetchDataExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<RegistrationFetchUserDataResponse> createResponseMessageObject() {
        ResponseMessage<RegistrationFetchUserDataResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new RegistrationFetchUserDataResponse());
