 ...
 */
public class RegVerifyXferExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<RegistrationVerifyTransferMoneyResponse> createResponseMessageObject() {
        ResponseMessage<RegistrationVerifyTransferMoneyResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new RegistrationVerifyTransferMoneyResponse());
