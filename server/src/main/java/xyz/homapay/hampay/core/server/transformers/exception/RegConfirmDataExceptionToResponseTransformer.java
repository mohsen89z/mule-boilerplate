 ...
 */
public class RegConfirmDataExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<RegistrationConfirmUserDataResponse> createResponseMessageObject() {
        ResponseMessage<RegistrationConfirmUserDataResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new RegistrationConfirmUserDataResponse());
