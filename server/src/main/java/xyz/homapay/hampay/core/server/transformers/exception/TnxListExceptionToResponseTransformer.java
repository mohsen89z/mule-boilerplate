 ...
 */
public class TnxListExceptionToResponseTransformer extends AbstractMessageTransformer {
    ...
    private ResponseMessage<TransactionListResponse> createResponseMessageObject() {
        ResponseMessage<TransactionListResponse> responseMessage = new ResponseMessage<>();
        responseMessage.setService(new TransactionListResponse());
