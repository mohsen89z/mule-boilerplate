...
public class SmsLocator extends org.apache.axis.client.Service implements xyz.homapay.hampay.smsgateway.model.remote.Sms {
    ...
    private java.lang.String smsSoap12_address = "http://192.168.50.66/webservice/sms.asmx";
    ...
    public xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_PortType getsmsSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            xyz.homapay.hampay.smsgateway.model.remote.SmsSoap12Stub _stub = new xyz.homapay.hampay.smsgateway.model.remote.SmsSoap12Stub(portAddress, this);
    ...
    private java.lang.String smsSoap_address = "http://192.168.50.66/webservice/sms.asmx";
    ...
    public xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_PortType getsmsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_BindingStub _stub = new xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                xyz.homapay.hampay.smsgateway.model.remote.SmsSoap12Stub _stub = new xyz.homapay.hampay.smsgateway.model.remote.SmsSoap12Stub(new java.net.URL(smsSoap12_address), this);
                _stub.setPortName(getsmsSoap12WSDDServiceName());
                return _stub;
            }
            if (xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_BindingStub _stub = new xyz.homapay.hampay.smsgateway.model.remote.SmsSoap_BindingStub(new java.net.URL(smsSoap_address), this);
                _stub.setPortName(getsmsSoapWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sms1000.ir/", "sms");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sms1000.ir/", "smsSoap12"));
            ports.add(new javax.xml.namespace.QName("http://sms1000.ir/", "smsSoap"));
        }
    ...
    public void setEndpointAddress(java.lang.String portName, java.lang.String address) throws javax.xml.rpc.ServiceException {
        ...
        } else if ("smsSoap".equals(portName)) {
